...
for i in range(1, num_epoch+1):
    ...
    if (accuracy> max_accuracy and accuracy>99.4):
        max_accuracy = accuracy 
        model_path = f"/home/r320/wooseok/MNISTClassification/weights/Finetune_mergeddata_GAP_adam_reduceLR_5555kernel{i:03d}ep_acc{max_accuracy}acc2{accuracy2}.pth"
    ...
    if (accuracy2> max_accuracy2 and accuracy2>96.5):
